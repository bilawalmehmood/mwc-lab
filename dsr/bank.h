...
class BankEntry
{
 ...
 public:
  ...
  // increment the chip amount of this bank entry
  void incChipAmount(double val);
  // decrement the chip amount of this bank entry
  void decChipAmount(double val);
  // return the current rating
  int getRating();
  // sets the current rating
  void setRating(int val);
  // increment the rating
  void incRating(int val);
  // decrement the rating
  void decRating(int val);
